...
def perspective_proj_withz(
    X, cam, offset_z=0, cuda_device=0, norm_f=1.0, norm_z=0.0, norm_f0=0.0
):
    """
    X: B x N x 3
    cam: B x 3: [f, cx, cy]
    TODO: offset_z is for being compatible with previous code and is not
